...
import bio.terra.workspace.service.resource.controlled.flight.delete.gcp.DeleteControlledResourceFlight;
...
public class ControlledResourceService {
  ...
  public JobBuilder commonCreationJobBuilder(
   ...
   */
  public JobBuilder commonDeletionJobBuilder(
      String jobId,
      UUID workspaceId,
      UUID resourceId,
      String resultPath,
