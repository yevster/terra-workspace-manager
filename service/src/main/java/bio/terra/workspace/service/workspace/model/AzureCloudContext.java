...
public class AzureCloudContext {
  ...
  public StorageManager getAzureStorageManager() {
    ...
    AzureEnvironment azureEnvironment = getAzureEnvironmentByName(this.getAzureEnvironment());

    return StorageManager.authenticate(
        azureCredential,
        new AzureProfile(this.getAzureTenantId(), this.getAzureSubscriptionId(), azureEnvironment));
  }
